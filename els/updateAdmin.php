                        ...
                        <form method="post">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="admDepartment" class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                        ...
                                        ?>
                                            <option value="<?= $fetchDepartmentList["dprtAbbr"] ?>" <?php
                                                                                                    if ($fetchDepartmentList["dprtAbbr"] == $fetchUserInfo["admDepartment"]) {
                                                                                                        echo "selected";
                                                                                                    }
                                                                                                    ?>><?= $fetchDepartmentList["dprtName"] ?> (<?= $fetchDepartmentList["dprtAbbr"] ?>)</option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                </div>
                                <input type="hidden" name="admID" value="<?= $userID ?>">
