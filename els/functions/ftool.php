...
if (isset($_POST["btnAddTool"])) {
	...
	if ($checkToolResult === 1) {
		...
		$itool = mysqli_query($conn, "INSERT INTO tools (tlName, tlVariation, tlQuantity, tlAvailable, tlLeft, tlStore) VALUES ('{$tlName}', '{$tlVariation}', '{$tlQuantity}', '{$tlAvailable}','{$tlLeft}', '{$tlStore}') ");
